...
export const zwermSpec: SimSpec = {
  ...
  background: "#0b0c0e",
  pointerHint: {
    nl: "Klik en sleep om de zwerm op te schrikken.",
    en: "Click and drag to startle the flock.",
  },
  defaults: {
    aantal: 520,
    zicht: 52,
  ...
  controls: [
    {
      kind: "slider",
      key: "aantal",
      label: { nl: "Aantal vogels", en: "Number of birds" },
      min: 60,
      max: 1400,
      step: 20,
      resets: true,
    },
    {
      kind: "slider",
      key: "zicht",
      label: { nl: "Zichtstraal", en: "Field of view" },
      min: 14,
      max: 120,
      step: 1,
    },
    {
      kind: "slider",
      key: "scheiding",
      label: { nl: "Scheiding", en: "Separation" },
      min: 0,
      max: 4,
      step: 0.05,
    },
    {
      kind: "slider",
      key: "uitlijning",
      label: { nl: "Uitlijning", en: "Alignment" },
      min: 0,
      max: 8,
      step: 0.1,
    },
    ...
    },
    {
      kind: "slider",
      key: "sporen",
      label: { nl: "Sporen", en: "Trails" },
      min: 0.02,
      max: 1,
      step: 0.02,
      format: (v, locale) =>
        v >= 0.99 ? (locale === "nl" ? "geen" : "none") : decimal(v, locale, 2),
    },
    {
      kind: "toggle",
      key: "verbindingen",
      label: { nl: "Toon buren", en: "Show neighbours" },
    },
  ],
};
