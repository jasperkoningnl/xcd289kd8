...
export const patroonSpec: SimSpec = {
  create: () => new Patroon(),
  background: "#0b0c0e",
  pointerHint: "Klik en sleep om stof B toe te voegen.",
  defaults: {
  ...
  controls: [
    {
      ...
      options: [
        { value: "kronkels", label: "Kronkels" },
        { value: "stippen", label: "Stippen" },
        { value: "strepen", label: "Strepen" },
        { value: "koraal", label: "Koraal" },
        { value: "mitose", label: "Mitose" },
    ...
    { kind: "slider", key: "tempo", label: "Stappen per beeld", min: 1, max: 24, step: 1 },
    {
      kind: "slider",
      key: "grofheid",
      label: "Grofheid rooster",
      min: 2,
      max: 8,
      step: 1,
      resets: true,
